...
const I18N = {
  pt: {
    ...
    "hero.loc": "Maceió/AL — Brasil", "hero.exp": "7 sistemas em produção",
    ...
    "about.f3k": "Idiomas", "about.f3v": "Português (nativo) · Inglês avançado",
    ...
    "contact.lead": "Fique à vontade para entrar em contato para falar sobre projetos e tecnologia.",
  ...
  en: {
    ...
    "hero.loc": "Maceió/AL — Brazil", "hero.exp": "7 systems in production",
    ...
    "about.f3k": "Languages", "about.f3v": "Portuguese (native) · English (professional working)",
    ...
    "contact.lead": "Feel free to reach out to talk about projects and technology.",
...
const PROJECTS = [
  ...
  {
    id: "importa_igps",
    repo: "https://github.com/Patoxzor/payroll-excel-importer-showcase",
    feat: false,
    tag: { pt: "Desktop · ETL", en: "Desktop · ETL" }, tagAlt: false,
    name: { pt: "Importador de Folha — ETL Excel → SQL Server", en: "Payroll Excel Importer — SQL Server ETL" },
    desc: {
